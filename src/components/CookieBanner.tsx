...
export default function CookieBanner() {
  ...
  return (
    <div className="fixed inset-x-0 bottom-0 z-[60] border-t border-black/10 bg-navy px-6 py-4 text-cream shadow-[0_-4px_20px_rgba(0,0,0,0.15)]">
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-4 md:flex-row md:justify-between">
        ...
        <div className="flex shrink-0 gap-3">
          <button
            ...
            className="rounded-md border border-cream/30 px-4 py-2 text-sm font-medium text-cream transition hover:bg-cream/10"
          >
            Decline
          </button>
          <button
